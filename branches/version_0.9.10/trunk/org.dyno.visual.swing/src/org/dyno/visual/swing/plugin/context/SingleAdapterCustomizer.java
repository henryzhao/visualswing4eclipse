...
public class SingleAdapterCustomizer extends ContextCustomizerAdapter {
	...
	public void fillContextMenu(MenuManager menuManager,
		...
		if (selected.size() == 1) {
			...
			WidgetAdapter contextAdapter = WidgetAdapter
					.getWidgetAdapter(context_comp);
			if (contextAdapter != null) {
				IMenuContext context = (IMenuContext) contextAdapter
						.getAdapter(IMenuContext.class);
				if (context != null)
					context.fillContextAction(menuManager);
			}
		}
	}
}
