...
public class HorizontalBilateralToTrailing extends AbstractOperation {
	private Constraints oldconstraints;
	private JComponent container;
	private Component child;

	public HorizontalBilateralToTrailing(Constraints constraints,
			JComponent container, Component child) {
		super(Messages.HorizontalBilateralToTrailing_Set_Anchor);
	...
	public IStatus execute(IProgressMonitor monitor, IAdaptable info)
		...
		Constraints newconstraints = new Constraints(new Trailing(t, 10, l),
